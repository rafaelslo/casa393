...
public class ItemSensor {
	...
	public ItemSensor(XmlPullParser parser) throws XmlPullParserException,
			IOException {
	...
	private String leTag(XmlPullParser parser, String tag) throws IOException,
		...
		// RAFAEL System.out.println("Achou: " + tag + " result: " + result);
		return result;
	}

	public String toString() {
		return this.local + this.descricao + this.id + this.pavimento + this.sistema + this.valor;
	}
